...
<Info>
	**🚧 In Development**: This feature is currently being developed and it will
	be deployed soon. Documentation will be updated once it's live. Any
	suggestions can be sent to us via TeamM's ticketing system. Stay tuned for
	updates!
</Info>
...
For analyzing meal skipping patterns across all guests, you can access the comprehensive **Meal Skipping Report** view directly in the main guests table.

### How to Access the Report

1. Go to the main **Guests** section
2. Create a new view
3. Select **"Meal Skipping Report"** from the dropdown
4. The table will switch to show meal skipping analytics

### Filtering Options

The report view provides flexible filtering options:
...
The Meal Skipping Report displays:

-   **Summary Statistics** at the top showing total guests and skipping patterns
...
1. Filter by the dates you want to plan for
2. Look at the **Daily Breakdown** section
3. Note the skipping counts for each meal type
4. Calculate portions: Total Guests - Skipping Count = Meals to Prepare

#### Session Planning

1. Select a specific session ID
2. Review the complete meal skipping patterns
3. Plan ingredient orders based on total skipping statistics
4. Identify patterns (e.g., many guests skip breakfast)

<Tip>
	**Pro Tip**: Use the date range filter to compare meal skipping patterns
	between different weeks or months to identify trends and optimize your
	kitchen operations.
</Tip>
...
For comprehensive analytics and kitchen planning, use the dedicated [GET /guests/meal-skipping API endpoint](/api-reference/endpoint/get-guests-meal-skipping) which provides:

-   **Summary statistics** - Total guests and skipping patterns
